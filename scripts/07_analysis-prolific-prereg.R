...
dat <- read_csv("data/final_dat_prolific.csv")
...
m_trust_h1_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                            Facial_Cue | # IVs
                            Batch + PID + Elite | # fixed effects
                            0 | # no instruments
                            Batch, # cluster
...
modelsummary(list(m_trust_h1_s, m_trust_h1_s_withoutPIDcluster), stars = T)
...
m_trust_h2_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                            Facial_Cue * Elite_InParty | # IVs
                            Batch + PID + Elite | # fixed effects
                            0 | # no instruments
                            Batch, # cluster
...
modelsummary(list(m_trust_h2_s, m_trust_h2_s_withoutPIDcluster), stars = T)
...
m_trust_h3a_1_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                               Facial_Cue * News_Bias | # IVs
                               Batch + PID + Elite | # fixed effects
                               0 | # no instruments
                               Batch, # cluster
...
m_trust_h3a_2_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                               Facial_Cue * News_Bias2 | # IVs
                               Batch + PID + Elite | # fixed effects
                               0 | # no instruments
                               Batch, # cluster
...
modelsummary(list(m_trust_h3a_1_s, m_trust_h3a_1_s_withoutPIDcluster), stars = T)

modelsummary(list(m_trust_h3a_2_s, m_trust_h3a_2_s_withoutPIDcluster), stars = T)
...
m_feeling_h4_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                              Facial_Cue | # IVs
                              Batch + PID + Elite | # fixed effects
                              0 | # no instruments
                              Batch, # cluster
...
modelsummary(list(m_feeling_h4_s, m_feeling_h4_s_withoutPIDcluster), stars = T)
...
m_feeling_h5_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                              Facial_Cue * Elite_InParty | # IVs
                              Batch + PID + Elite | # fixed effects
                              0 | # no instruments
                              Batch, # cluster
...
modelsummary(list(m_feeling_h5_s, m_feeling_h5_s_withoutPIDcluster), stars = T)
...
m_feeling_h6a_1_s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                                 Facial_Cue * News_Bias | # IVs
                                 Batch + PID + Elite | # fixed effects
                                 0 | # no instruments
                                 Batch, # cluster
...
m_feeling_h6a_2s_withoutPIDcluster <- lfe::felm(scale_variable(Response) ~ # DV
                                Facial_Cue * News_Bias2 | # IVs
                                Batch + PID + Elite | # fixed effects
                                0 | # no instruments
                                Batch, # cluster
...
modelsummary(list(m_feeling_h6a_1_s, m_feeling_h6a_1_s_withoutPIDcluster), stars = T)
           
modelsummary(list(m_feeling_h6a_2s, m_feeling_h6a_2s_withoutPIDcluster), stars = T)
...
# the models are named based on the in-text hypotheses
# this is different from the names  of the pre-registered hypotheses
# in-text : pre-registered map
# H1 : H1
# H2 : H4
# H3a : H2
# H3b : H5
...
modelsummary(list("Trust H1" = m_trust_h1_s_withoutPIDcluster,
                  "Feel H2" = m_feeling_h4_s_withoutPIDcluster,
                  "Trust H3a" = m_trust_h2_s_withoutPIDcluster,
                  "Feel H3b" = m_feeling_h5_s_withoutPIDcluster,
                  "Trust H4a" = m_trust_h3a_1_s_withoutPIDcluster,
                  "Feel H4b" = m_feeling_h6a_1_s_withoutPIDcluster),
             stars = c('*' = .05, '**' = .01, '***' = .001),
             estimate  = c("{estimate}{stars} ({std.error})"),
             statistic = NULL,
             coef_omit = "Intercept",
             notes = list('p-values: * < 0.05 ** < 0.01 *** < 0.001'),
             output = "results/model_outputs/01_preregistered.png")
...
modelsummary(list("Trust H1" = m_trust_h1_s_withoutPIDcluster,
             ...
             coef_omit = "Intercept",
             notes = list('p-values: * < 0.05 ** < 0.01 *** < 0.001'),
             output = "results/model_outputs/01_preregistered.docx")
