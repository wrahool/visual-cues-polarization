# sub-group analysis for republicans (partisanship > 3)
...
# remove Elite from F.E. because matrix was rank deficient
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             output = "results/model_outputs/04_republicans.png")
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             coef_omit = "Intercept",
             notes = list('p-values: * < 0.05 ** < 0.01 *** < 0.001'),
             output = "results/model_outputs/04_republicans.docx")
