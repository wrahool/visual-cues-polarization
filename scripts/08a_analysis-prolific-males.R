...
q_details <- read_csv("../data/question-condition-mapping.csv")
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             output = "results/model_outputs/02_males.png")
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             coef_omit = "Intercept",
             notes = list('p-values: * < 0.05 ** < 0.01 *** < 0.001'),
             output = "results/model_outputs/02_males.docx")
